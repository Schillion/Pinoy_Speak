...
communities. \citeA{b2} describes code-switching as a systematic linguistic
practice rather than a random mixture of languages. In the Philippine setting, Tagalog-English
...
\citeA{b4} notes that digital environments create new forms of
written expression because users adapt language to speed,
identity, humor, and platform conventions. In Filipino
...
involve context-sensitive meaning. \citeA{b12} developed a Filipino metaphor identification study
...
misspelled, and morphologically varied words. \citeA{b5} introduced FastText word representations that model
...
across contexts. \citeA{b7} showed that diachronic word embeddings can reveal
statistical patterns of semantic change. \citeA{b8} further
surveyed methods for tracking semantic shifts using word
embeddings, while \citeA{b9} proposed dynamic word embeddings
for modeling language change through time.
